...
const AGENT_DASHBOARD =
  "/BINGO_AGENT_DASHBOARD_FOOD_SEPARATED_2026-09-22.html";

export default function AgentPage() {
  const [loaded, setLoaded] = useState(false);

  useEffect(() => {
    document.title = "Bingo Agent Dashboard";
  }, []);

  return (
    <main className="min-h-screen bg-[#0B0E14] text-white">
      {/* Bingo Agent navigation */}
      ...
      {/* Exact approved Agent dashboard */}
          ...
          <div className="absolute inset-0 z-10 flex items-center justify-center bg-[#0B0E14]">
            <div className="text-center">
              ...
              <div className="mt-4 text-sm font-bold text-cyan-300">
                Opening Bingo Agent Dashboard...
              </div>

              <div className="mt-1 text-xs text-slate-500">
                Loading approved Agent interface
              </div>
            </div>
          </div>
        )}
